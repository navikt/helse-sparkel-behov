...
internal class UtbetalingsperiodeløserV1(
    ...
    init {
        River(rapidsConnection).apply {
            ...
            validate { it.rejectKey("$behov.historikkFom") }
            validate { it.rejectKey("$behov.historikkTom") }
    ...
    override fun onPacket(packet: JsonMessage, context: RapidsConnection.MessageContext) {
        ...
        val historikkFom = json.path("${behov}.historikkFom").asLocalDate()
        val historikkTom = json.path("${behov}.historikkFom").asLocalDate()
...
internal class UtbetalingsperiodeløserV2(
    rapidsConnection: RapidsConnection,
    private val infotrygdService: InfotrygdService
) : River.PacketListener {
